package com.ccooy.gankio.module.navabout
...
import com.ccooy.gankio.utils.PackageUtil
    ...
    fun onClick(view: View) {
        when (view.id) {
            ...
            R.id.tv_about_star -> {
                ...
                intent.putExtra(WebViewActivity.GANK_URL, resources.getString(R.string.string_url_gank))
